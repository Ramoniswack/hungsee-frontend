      ...
      <div className="w-full max-w-[600px] bg-[#0f172a] border border-white/5 p-8 md:p-12 relative overflow-hidden rounded-xl">
        ...
        <div className="space-y-8 relative z-10">
          ...
          <div className="text-center mt-4">
            <Link href="/member/classes" style={{ fontFamily: "'Inter', sans-serif", fontSize: '0.8rem', color: '#64748b', textDecoration: 'underline' }} className="hover:text-white transition-colors">
              Cancel
            </Link>
          </div>
        </div>

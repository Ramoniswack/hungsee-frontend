      ...
      <header className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 border-b border-white/5 pb-8">
        <div className="flex items-center gap-6">
          <div className="w-24 h-24 rounded-full bg-gradient-to-tr from-[#93c5fd] to-[#1e3a8a] flex items-center justify-center border-4 border-[#0b1120] shadow-xl overflow-hidden relative group">
            <span style={{ fontFamily: "'Oswald', sans-serif", fontSize: '2.5rem', fontWeight: 700, color: 'var(--text-main, #ffffff)' }}>AC</span>
          ...
          <div>
            ...
            <div className="flex items-center gap-3 mt-2">
              ...
              <span style={{ fontFamily: "'Inter', sans-serif", fontSize: '0.8rem', color: 'var(--text-muted-lighter, #64748b)' }}>Member since 2024</span>
            </div>
          </div>
        </div>
        ...
        <div className="flex w-full md:w-auto mt-6 md:mt-0 bg-[#0f172a] md:bg-transparent p-4 md:p-0 rounded-xl md:rounded-none border border-white/5 md:border-0 justify-around md:justify-end gap-0 md:gap-8 items-center">
          <div className="text-center md:text-right">
            <p style={{ fontFamily: "'Inter', sans-serif", fontSize: '0.65rem', fontWeight: 700, letterSpacing: '0.15em', textTransform: 'uppercase', color: 'var(--text-muted-lighter, #64748b)' }}>Current Streak</p>
            <p style={{ fontFamily: "'Oswald', sans-serif", fontSize: '1.8rem', fontWeight: 700, color: 'var(--text-main, #ffffff)' }} className="flex items-center justify-center md:justify-end gap-2 leading-none mt-1">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-gradient-to-r from-[#0f172a] to-[#1e3a8a]/20 border border-[#93c5fd]/20 p-6 rounded-lg relative overflow-hidden flex items-center justify-between">
            ...
            <div className="flex flex-col items-end">
              <span style={{ fontFamily: "'Oswald', sans-serif", fontSize: '1.5rem', fontWeight: 700, color: 'var(--text-main, #ffffff)' }}>7/10</span>
          ...
          <div className="bg-[#0f172a] border border-white/5 p-8 relative overflow-hidden group hover:border-white/20 transition-all">
            <h2 style={{ fontFamily: "'Inter', sans-serif", fontSize: '0.75rem', fontWeight: 700, letterSpacing: '0.2em', textTransform: 'uppercase', color: 'var(--text-muted-light, #94a3b8)', marginBottom: '1.5rem' }}>Your Next Session</h2>
          ...
          <div className="bg-[#0f172a] border border-white/5 p-8">
            <div className="flex justify-between items-end mb-6">
              <h2 style={{ fontFamily: "'Inter', sans-serif", fontSize: '0.75rem', fontWeight: 700, letterSpacing: '0.2em', textTransform: 'uppercase', color: 'var(--text-muted-light, #94a3b8)' }}>Upcoming Schedule</h2>
              <Link href="/member/classes" style={{ fontFamily: "'Inter', sans-serif", fontSize: '0.75rem', fontWeight: 700, letterSpacing: '0.1em', textTransform: 'uppercase', color: 'var(--text-main, #ffffff)' }} className="hover:text-[#93c5fd] transition-colors">
                + Add Class
              </Link>
            </div>
              ...
              <div className="flex justify-between items-center p-4 border border-white/5 bg-[#0b1120] hover:border-white/20 transition-colors">
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 bg-white/5 flex flex-col items-center justify-center text-center">
                    <span style={{ fontFamily: "'Inter', sans-serif", fontSize: '0.6rem', fontWeight: 700, textTransform: 'uppercase', color: 'var(--text-muted-lighter, #64748b)' }}>THU</span>
                    <span style={{ fontFamily: "'Oswald', sans-serif", fontSize: '1.1rem', fontWeight: 700, color: 'var(--text-main, #ffffff)', lineHeight: 1 }}>24</span>
                  </div>
                  <div>
                    <h4 style={{ fontFamily: "'Oswald', sans-serif", fontSize: '1.2rem', fontWeight: 500, color: 'var(--text-main, #ffffff)', textTransform: 'uppercase' }}>Vinyasa Yoga</h4>
          ...
          <div className="bg-[#0f172a] border border-white/5 p-8">
             <h2 style={{ fontFamily: "'Inter', sans-serif", fontSize: '0.75rem', fontWeight: 700, letterSpacing: '0.2em', textTransform: 'uppercase', color: 'var(--text-muted-light, #94a3b8)', marginBottom: '1.5rem' }}>Recent Badges</h2>
             <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
               {[
                 ...
                 <div key={i} className={`p-4 border border-white/5 flex flex-col items-center text-center gap-3 transition-all hover:bg-white/5 cursor-pointer ${b.locked ? 'opacity-40 grayscale' : ''}`}>
                   ...
                   <span style={{ fontFamily: "'Inter', sans-serif", fontSize: '0.75rem', fontWeight: 700, textTransform: 'uppercase', color: 'var(--text-main, #ffffff)' }}>{b.name}</span>
                 </div>
               ))}
             </div>
          </div>
        ...
        <div className="space-y-6">
          <div className="bg-[#0f172a] border border-[#93c5fd]/20 p-8 relative">
            ...
            <h2 style={{ fontFamily: "'Inter', sans-serif", fontSize: '0.75rem', fontWeight: 700, letterSpacing: '0.2em', textTransform: 'uppercase', color: 'var(--text-muted-light, #94a3b8)', marginBottom: '1.5rem' }}>Access Pass</h2>
            <h3 style={{ fontFamily: "'Oswald', sans-serif", fontSize: '2.5rem', fontWeight: 700, color: 'var(--text-main, #ffffff)', textTransform: 'uppercase', lineHeight: 1 }}>PRO</h3>
            <div className="mt-6 space-y-3 pt-6 border-t border-white/5">
              <div className="flex justify-between items-center">
                <span style={{ fontFamily: "'Inter', sans-serif", fontSize: '0.8rem', color: 'var(--text-muted-lighter, #64748b)' }}>Renewal</span>
                <span style={{ fontFamily: "'Inter', sans-serif", fontSize: '0.8rem', fontWeight: 600, color: 'var(--text-muted, #cbd5e1)' }}>Dec 20, 2026</span>
              </div>
              <div className="flex justify-between items-center">
                <span style={{ fontFamily: "'Inter', sans-serif", fontSize: '0.8rem', color: 'var(--text-muted-lighter, #64748b)' }}>Guest Passes</span>
                <span style={{ fontFamily: "'Inter', sans-serif", fontSize: '0.8rem', fontWeight: 600, color: 'var(--text-muted, #cbd5e1)' }}>2 Remaining</span>
              </div>
            </div>
          ...
          <div className="bg-[#0f172a] border border-white/5 p-8">
            <h2 style={{ fontFamily: "'Inter', sans-serif", fontSize: '0.75rem', fontWeight: 700, letterSpacing: '0.2em', textTransform: 'uppercase', color: 'var(--text-muted-light, #94a3b8)', marginBottom: '1.5rem' }}>Activity Breakdown</h2>
            <div className="space-y-4">
              <div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <button className="bg-[#0f172a] border border-white/5 p-4 flex flex-col items-center justify-center gap-2 hover:bg-white/5 transition-colors">
              ...
              <span style={{ fontFamily: "'Inter', sans-serif", fontSize: '0.65rem', fontWeight: 700, letterSpacing: '0.1em', textTransform: 'uppercase', color: 'var(--text-muted, #cbd5e1)' }}>Billing</span>
            </button>
            <button className="bg-[#0f172a] border border-white/5 p-4 flex flex-col items-center justify-center gap-2 hover:bg-white/5 transition-colors">
              ...
              <span style={{ fontFamily: "'Inter', sans-serif", fontSize: '0.65rem', fontWeight: 700, letterSpacing: '0.1em', textTransform: 'uppercase', color: 'var(--text-muted, #cbd5e1)' }}>Profile</span>
            </button>
          </div>
      ...
      {showQR && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm" onClick={() => setShowQR(false)}>
          <div className="bg-[#0f172a] border border-white/10 p-8 max-w-sm w-full text-center relative" onClick={e => e.stopPropagation()}>
            ...
            <h3 style={{ fontFamily: "'Oswald', sans-serif", fontSize: '1.5rem', fontWeight: 700, color: 'var(--text-main, #ffffff)', textTransform: 'uppercase', marginBottom: '1.5rem' }}>Scan at Reception</h3>
            ...
            <p style={{ fontFamily: "'Inter', sans-serif", fontSize: '0.9rem', color: 'var(--text-muted, #cbd5e1)' }}>Class: <strong className="text-white">{nextClass.name}</strong></p>
            <p style={{ fontFamily: "'Inter', sans-serif", fontSize: '0.8rem', color: 'var(--text-muted-lighter, #64748b)', marginTop: '0.2rem' }}>Valid for today only</p>
          </div>
        </div>
      )}
